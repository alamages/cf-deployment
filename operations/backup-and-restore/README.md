...
| [`enable-backup-restore-gcs.yml`](enable-backup-restore-gcs.yml) | Enables the backup and restore of GCS blobstores with versioning enabled. | Requires `enable-backup-restore.yml` and `use-gcs-blobstore-service-account.yml` |
